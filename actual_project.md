...
```
    ...
    <ipython-input-7-fad8302c8f7a> in <module>
    ----> 1 edu_list = [edu_spend16, edu_spend17, edu_spend18, edu_spend19, edu_spend20]
          2 edu_spending = pd.concat(edu_list)


    NameError: name 'edu_spend16' is not defined
